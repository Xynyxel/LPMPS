...
@section('content')
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<div class="w-100">
						<form action="/lpmp/comment" method="post">
							{{ csrf_field() }}
	...
	<script>
        ...
        const getData = async () => {
            ...
            const response = await fetch(`${url}/lpmp/comments/${id ? id : 0}`);
        ...
        const getComments = async () => {
            ...
            if (comments.length > 0) {
                comments.forEach(comment => {
                    ...
                    const direction = comment.status_pemberi_komentar == 3 ? "right" : "left"
                    listComment.innerHTML += `
		...
		const table = ['table-raport-sekolah','table-sekolah']
		$(document).ready(function() {
			table.forEach(id => {
				$(`#${id}`).DataTable();
			});
