...
@section('content')
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-primary" onclick="add('sekolah')" data-toggle="modal"
                            data-target="#sekolah">Tambah</button>
                    </div>
                    <div class="card-body">
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a onclick="edit('sekolah',{{ $sekolah->id }})"
                                                                class="dropdown-item" data-toggle="modal"
                                                                data-target="#sekolah">
                                                                <i class="fa fa-edit"></i>Edit
                                                            </a>
                                                            <a href="/sekolah/hapus/{{ $sekolah->id }}"
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button onclick="add('standar')" class="btn btn-primary" data-toggle="modal"
                            data-target="#standar">Tambah</button>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive border-top-0">
                                    ...
                                    @if ($listStandar->count() > 0)
                                        ...
                                        @foreach ($listStandar as $standar)
                                            <tr>
                                                ...
                                                <td>{{ $standar->nama }}</td>
                                                <td><span
                                                        class="badge badge-success-100 text-success">{{ $standar->status }}</span>
                                                </td>
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        <a href="#"
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a onclick="edit('standar',{{ $standar->id }})"
                                                                class="dropdown-item" data-toggle="modal"
                                                                data-target="#standar">
                                                                <i class="fa fa-edit"></i>Edit
                                                            </a>
                                                            <a href="/standar/hapus/{{ $standar->id }}"
                                                                class="dropdown-item"><i class="fa fa-trash"></i>Hapus</a>
                                                        </div>
                                                    </div>
                                                </td>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button onclick="add('indikator')" class="btn btn-primary" data-toggle="modal"
                            data-target="#indikator">Tambah</button>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive border-top-0">
                                    ...
                                    @if ($listIndikator->count() > 0)
                                        ...
                                        @foreach ($listIndikator as $indikator)
                                            <tr>
                                                ...
                                                <td><span
                                                        class="badge badge-success-100 text-success">{{ $indikator->status }}</span>
                                                </td>
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        <a href="#"
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a onclick="edit('indikator',{{ $indikator->id }})"
                                                                class="dropdown-item" data-toggle="modal"
                                                                data-target="#indikator">
                                                                <i class="fa fa-edit"></i>Edit
                                                            </a>
                                                            <a href="/indikator/hapus/{{ $indikator->id }}"
                                                                class="dropdown-item"><i class="fa fa-trash"></i>Hapus</a>
                                                        </div>
                                                    </div>
                                                </td>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button onclick="add('subIndikator')" class="btn btn-primary" data-toggle="modal"
                            data-target="#subIndikator">Tambah</button>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive border-top-0">
                                    ...
                                    @if ($listSubIndikator->count() > 0)
                                        ...
                                        @foreach ($listSubIndikator as $subIndikator)
                                            <tr>
                                                ...
                                                <td><span
                                                        class="badge badge-success-100 text-success">{{ $subIndikator->status }}</span>
                                                </td>
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        <a href="#"
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a onclick="edit('subIndikator',{{ $subIndikator->id }})"
                                                                class="dropdown-item" data-toggle="modal"
                                                                data-target="#subIndikator">
                                                                <i class="fa fa-edit"></i>Edit
                                                            </a>
                                                            <a href="/subIndikator/hapus/{{ $subIndikator->id }}"
                                                                class="dropdown-item"><i class="fa fa-trash"></i>Hapus</a>
                                                        </div>
                                                    </div>
                                                </td>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button onclick="add('akarMasalah')" class="btn btn-primary" data-toggle="modal"
                            data-target="#akarMasalah">Tambah</button>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive border-top-0">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a onclick="edit('akarMasalah',{{ $akarMasalah->id }})"
                                                                class="dropdown-item" data-toggle="modal"
                                                                data-target="#akarMasalah">
                                                                <i class="fa fa-edit"></i>Edit
                                                            </a>
                                                            <a href="/akarMasalah/hapus/{{ $akarMasalah->id }}"
                                                                class="dropdown-item"><i class="fa fa-trash"></i>Hapus</a>
                                                        </div>
                                                    </div>
                                                </td>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button onclick="add('kota')" class="btn btn-primary" data-toggle="modal"
                            data-target="#kota">Tambah</button>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive border-top-0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a onclick="edit('kota',{{ $kota->id }})"
                                                                class="dropdown-item" data-toggle="modal"
                                                                data-target="#kota">
                                                                <i class="fa fa-edit"></i>Edit
                                                            </a>
                                                            <a href="/kotaKabupaten/hapus/{{ $kota->id }}"
                                                                class="dropdown-item"><i class="fa fa-trash"></i>Hapus</a>
                                                        </div>
                                                    </div>
                                                </td>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button onclick="add('tpmps')" class="btn btn-primary" data-toggle="modal"
                            data-target="#tpmps">Tambah</button>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive border-top-0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a onclick="edit('tpmps',{{ $tpmps->id }})"
                                                                class="dropdown-item" data-toggle="modal"
                                                                data-target="#tpmps">
                                                                <i class="fa fa-edit"></i>Edit
                                                            </a>
                                                            <a href="/tpmps/hapus/{{ $tpmps->id }}"
                                                                class="dropdown-item"><i class="fa fa-trash"></i>Hapus</a>
                                                        </div>
                                                    </div>
                                                </td>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button onclick="add('pengawas')" class="btn btn-primary" data-toggle="modal"
                            data-target="#pengawas">Tambah</button>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive border-top-0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a onclick="edit('pengawas',{{ $pengawas->id }})"
                                                                class="dropdown-item" data-toggle="modal"
                                                                data-target="#pengawas">
                                                                <i class="fa fa-edit"></i>Edit
                                                            </a>
                                                            <a href="/pengawas/hapus/{{ $pengawas->id }}"
                                                                class="dropdown-item"><i class="fa fa-trash"></i>Hapus</a>
                                                        </div>
                                                    </div>
                                                </td>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button onclick="add('lpmp')" class="btn btn-primary" data-toggle="modal"
                            data-target="#lpmp">Tambah</button>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive border-top-0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a onclick="edit('lpmp',{{ $lpmp->id }})"
                                                                class="dropdown-item" data-toggle="modal"
                                                                data-target="#lpmp">
                                                                <i class="fa fa-edit"></i>Edit
                                                            </a>
                                                            <a href="/lpmp/hapus/{{ $lpmp->id }}"
                                                                class="dropdown-item"><i class="fa fa-trash"></i>Hapus</a>
                                                        </div>
                                                    </div>
                                                </td>
                ...
                <form method="POST" action="/standar/tambah" id="form_standar">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="0" value="0" name="status" class="form-control" id="standar_status"
                                required />
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <!-- Modal Indikator -->
    <div class="modal fade" id="indikator" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form method="POST" action="/indikator/tambah" id="form_indikator">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="0" value="0" name="status" class="form-control" id="indikator_status"
                                required />
                        </div>
                        <div class="form-group">
    ...
    <!-- Modal Sub Indikator -->
    <div class="modal fade" id="subIndikator" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="0" value="0" name="status" class="form-control"
                                id="sub_indikator_status" required />
                        </div>
                        <div class="form-group">
    ...
    <!-- Modal Akar Masalah -->
    <div class="modal fade" id="akarMasalah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="/tpmps/tambah" id="form_tpmps">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="username" class="form-control" id="tpmps_username"/>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label">Password</label>
                            <input type="password" name="password" class="form-control" id="tpmps_password" required />
                        </div>
                        <div class="form-group">
    ...
    <!-- Modal Pengawas -->
    <div class="modal fade" id="pengawas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
    ...
    <script>
        ...
        const password = document.querySelector('#tpmps_password');
