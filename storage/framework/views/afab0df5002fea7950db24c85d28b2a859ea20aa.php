					...
					<tbody>
						<tr>
							<td>
								<div class="d-flex align-items-center">
									<a href="#" class="mr-3">
										<img src="<?php echo e(asset('images/brands/klm.svg')); ?>" class="rounded-circle" width="32" height="32" alt="">
									</a>
									<div>
							...
							<td>June 12th</td>
							<td><img src="<?php echo e(asset('images/brands/ups.svg')); ?>" class="mr-1" width="20" alt=""> UPS Express</td>
						...
						<tr>
							<td>
								<div class="d-flex align-items-center">
									<a href="#" class="mr-3">
										<img src="<?php echo e(asset('images/brands/amazon.svg')); ?>" class="rounded-circle" width="32" height="32" alt="">
									</a>
									<div>
							...
							<td>June 13th</td>
							<td><img src="<?php echo e(asset('images/brands/deutsche-post.svg')); ?>" class="rounded-sm mr-1" width="20" alt=""> Deutsche post</td>
						...
						<tr>
							<td>
								<div class="d-flex align-items-center">
									<a href="#" class="mr-3">
										<img src="<?php echo e(asset('images/brands/honda.svg')); ?>" class="rounded-circle" width="32" height="32" alt="">
									</a> 
									<div>
							...
							<td>June 14th</td>
							<td><img src="<?php echo e(asset('images/brands/postnl.svg')); ?>" class="mr-1" width="20" alt=""> PostNL</td>
						...
						<table class="table">
							...
							<tbody>
								<tr>
									<td>
										<div class="d-flex align-items-center">
											<img src="<?php echo e(asset('images/browsers/chrome.svg')); ?>" class="mr-2" alt=""
												style="height: 32px;">
											Chrome
										</div>
									</td>
								...
								<tr>
									<td>
										<div class="d-flex align-items-center">
											<img src="<?php echo e(asset('images/browsers/firefox.svg')); ?>" class="mr-2" alt=""
												style="height: 32px;">
											Firefox
										</div>
									</td>
...
<?php $__env->startSection('notification'); ?>
	...
	<!-- /notifications -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Leo\Project\Project Real\LPMPS\resources\views//admin/index.blade.php ENDPATH**/ ?>